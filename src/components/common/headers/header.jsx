...
const Header = ({ header_transparent }) => {
  const { headerSticky } = useSticky();
  const { setShowSidebar } = useGlobalContext();
  const [value, setValue] = useState('0xF74d ... 12hf204');
  ...
  return (
    <>
      <header>
        <div id="header-sticky" className={`header__area header__border header__padding header__bg 
        header__sticky ${headerSticky ? 'header-sticky' : ''} ${header_transparent ? header_transparent : ''}`}>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-xxl-8 col-xl-8 col-lg-5 d-none d-lg-block">
                  <div className="header__menu-wrapper d-flex align-items-center">
                    <div className="header__search mr-30 ml-5">
                      <form action="#">
                    ...
                    <div className="header__right d-none d-sm-flex justify-content-end align-items-center">
                      ...
                      <div className="header__wallet-wrapper" id="header__user">
                        <div className="header__wallet ml-30">
                          <Link href={'/wallet'}>
                            <a className="header__wallet-btn header__wallet-btn-2" id="connectbtn">
