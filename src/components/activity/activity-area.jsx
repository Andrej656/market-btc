...
const ActivityArea = () => {
  return (
    <>
      <section className="activity__area pt-80 pb-110 p-relative z-index-1">
        <div className="container">
          <div className="row">
            <div className="col-xxl-8 col-xl-8 col-lg-8">
              <div className="activity__wrapper mr-60">

                <ActivityItem svg={<svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M10.6691 6.54838L6.55412 10.6634C6.44752 10.7701 6.32092 10.8547 6.18158 10.9125C6.04223 10.9703 5.89287 11 5.74203 11C5.59119 11 5.44182 10.9703 5.30248 10.9125C5.16313 10.8547 5.03654 10.7701 4.92994 10.6634L0 5.73916V0H5.73916L10.6691 4.92994C10.8829 5.145 11.0029 5.43592 11.0029 5.73916C11.0029 6.0424 10.8829 6.33332 10.6691 6.54838Z" fill="white" /> <path d="M2.86914 2.8696H2.87542" stroke="#006EED" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>} title="Brave Tigers NFT" content={<p>1 edition listed by <Link href="/profile">
                  <a>@xander_hall</a></Link> for <span>0.048 ETH</span> each</p>} user="assets/img/activity/user-1.jpg" />

                <ActivityItem tag="heart" svg={<svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg>} title="Brave Tigers NFT" content={<p>like by <Link href="/profile"><a>@CloneX_1070</a>
                </Link></p>} user="assets/img/activity/user-2.jpg" />

                <ActivityItem tag="check" svg={<svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M11.1818 1L4.18182 8L1 4.81818" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>} title="Based Mafia" content={<p>started following <Link href="/profile"><a>@Ruüd van</a></Link> </p>} user="assets/img/activity/user-3.jpg" />

                <ActivityItem tag="bid" svg={<svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12.9372 11.1824C12.8366 11.283 12.7092 11.3299 12.5817 11.3299C12.4543 11.3299 12.3269 11.283 12.2262 11.1824L8.90625 7.86238L9.26173 7.5069L9.6172 7.15143L12.9372 10.4714C13.1317 10.6659 13.1317 10.9879 12.9372 11.1824Z" fill="white" /> <path d="M3.50116 4.63624L7.39126 8.52634C7.65283 8.78791 7.65283 9.21046 7.39126 9.47203L6.78762 10.0824C6.24435 10.6189 5.38584 10.6189 4.84928 10.0824L1.93841 7.17151C1.40855 6.64165 1.40855 5.77644 1.93841 5.23987L2.54875 4.62953C2.81033 4.37466 3.23958 4.37466 3.50116 4.63624Z" fill="white" /> <path d="M11.6304 5.24661L9.07497 7.79529C8.80668 8.06358 8.37743 8.06358 8.10915 7.79529L4.23246 3.91861C3.96418 3.65032 3.96418 3.22107 4.23246 2.95279L6.78786 0.397394C7.31771 -0.132465 8.18293 -0.132465 8.71949 0.397394L11.6304 3.30826C12.1602 3.84483 12.1602 4.70333 11.6304 5.24661Z" fill="white" /> <path d="M4.52727 13H0.50303C0.22804 13 0 12.772 0 12.497C0 12.222 0.22804 11.994 0.50303 11.994H4.52727C4.80226 11.994 5.0303 12.222 5.0303 12.497C5.0303 12.772 4.80226 13 4.52727 13Z" fill="white" />
                </svg>} title="New Year Evangelist" content={<p>bid cancelled by <Link href="/profile"><a>@Benjamin_025
                </a></Link> </p>} user="assets/img/activity/user-4.jpg" />

                <ActivityItem tag="eth" svg={<svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M9.25288 7.12967L4.87826 0V5.17527L8.70826 6.88648L4.87826 5.1763V9.66948L9.25288 7.12981L9.25302 7.12985L9.25298 7.12976L9.25302 7.12971L9.25288 7.12967ZM4.87709 5.17527V0L0.503024 7.12967L0.502931 7.12971L0.502978 7.12976L0.502931 7.12985L0.503071 7.12981L4.87709 9.66948V5.1763L1.0476 6.88648L4.87709 5.17527ZM4.87709 10.4835V14L0.5 7.94431L4.87709 10.4835ZM4.87826 10.4829V14L9.25302 7.94431L4.87826 10.4829Z" fill="white" />
                </svg>} user="assets/img/activity/user-5.jpg" title="Chickolatev2" content={<p>purchased by <Link
                  href="/profile"><a> @Ruüd van</a></Link>  for <span>0.2 ETH</span> from
                  <Link href="/profile"><a>@xander_hall</a></Link></p>} />

              </div>
            </div>
            <div className="col-xxl-4 col-xl-4 col-lg-4">
              <div className="activity__sidebar mr-10">
                <div className="activity__widget">
                  <h3 className="activity__widget-title">Filter by Tags</h3>

                  <div className="activity__filter-tag">
                    <a href="#">
                      <svg width="12" height="12" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M2.86914 2.8696H2.87542" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      Listings
                    </a>
                    <a href="#">
                    ...
                    <a href="#">
                      <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.6745 8.55304L9.23438 12" stroke="#8D8D8D" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1 8.55304H12.6729" stroke="#8D8D8D" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1 4.44694L4.44008 1" stroke="#8D8D8D" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M12.6729 4.44693H1" stroke="#8D8D8D" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      Transfer
                    </a>
                    <a href="#">
                    ...
                    <a href="#">
                      <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.1818 1L4.18182 8L1 4.81818" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      Followings
                    </a>
                  </div>
                  <div className="activity__filter-reset">
...
const ActivityItem = ({ tag, svg, user, title, content }) => {
  return (
    <>
      <div className="activity__item d-md-flex align-items-center justify-content-between mb-10">
        <div className="activity__item-inner d-flex align-items-center">
          <div className="activity__thumb mr-20">
            ...
            <span className={`activity__tag ${tag ? tag : ''}`}>
              {svg}
            </span>
          </div>
